...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Arrow arrow-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  arrow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arrow transaction") + "\n" +
              "  arrow-tx [options] -create [commands]   " + _("Create hex-encoded arrow transaction") + "\n" +
              "\n";
